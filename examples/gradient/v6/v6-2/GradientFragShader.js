...
void main() {
  ...
  gradientAlpha = pow(gradientAlpha, powValue);
  
  gl_FragColor = vec4(a_color, (edgeAlpha + gradientAlpha * (1.0 - edgeAlpha)) * alpha);
}
 `;
