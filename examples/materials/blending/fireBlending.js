...
(function(PGL) {
  ...
  Object.assign(PGL.scene3D.prototype, {
    ...
    init: function() {
      ...
      function animate() {
        ...
        if (_this.firstPersonControls) {
          ...
          _this.firstPersonControls.update(delta);
          if ( _this.mixer ) _this.mixer.update( delta );
        }
        _this.render();
        _this.stats.update();
      }
    ...
    initWebGLRenderer: function() {
      ...
      // this.webGLRenderer.setClearColor(0x00ffff);
    ...
    initFirstPersonControls: function() {
      this.firstPersonControls = new THREE.FirstPersonControls(this.camera, this.webGLRenderer.domElement);
    ...
    initOrbitControls: function() {
      ...
      this.orbitControls.enableRotatePhi = true;
    },
    initStats: function() {
    ...
    initObject: function() {
      ...
      loader.load('../../models/fbx/fire.FBX', function(object) {
        console.log(object);
        // scope.mixer = new THREE.AnimationMixer( object );
        // console.log(scope.mixer);
        // var action = scope.mixer.clipAction( object.animations[ 0 ] );
        // action.play();
