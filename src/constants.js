...
export var TrianglesDrawMode = 0; // 绘制三角形
export var TriangleStripDrawMode = 1; // 带状的三角形
export var TriangleFanDrawMode = 2; // 扇形的图形
